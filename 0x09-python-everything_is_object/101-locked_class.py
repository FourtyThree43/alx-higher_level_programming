...
class LockedClass:
    ...
    except for an attribute called 'first_name'.
    """
    ...
    def __setattr__(self, key, value):
        """
        Called when an instance attribute is set. Raises an AttributeError if
        the attribute being set is not 'first_name' and it does not already exist.
        """
